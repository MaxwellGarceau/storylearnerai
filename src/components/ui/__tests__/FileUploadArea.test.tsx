...
describe('FileUploadArea Component', () => {
  ...
  describe('Rendering', () => {
    it('renders with default state', () => {
      ...
      expect(screen.getByText(/Maximum file size: 5MB, Maximum pages: 10/)).toBeInTheDocument();
      const container = screen.getByTestId('default-render');
      const fileInput = container.querySelector('input[data-testid="pdf-file-input"]') as HTMLInputElement;
    ...
    it('renders with custom accept types', () => {
      render(<FileUploadArea {...defaultProps} accept=".txt,.doc" data-testid="custom-accept" />);
  ...
  describe('States', () => {
    it('applies default state styles', () => {
      ...
      expect(uploadArea).toHaveClass('border-gray-300', 'hover:border-gray-400');
    });
  ...
  describe('File Selection', () => {
    ...
    it('does not open file dialog when processing', async () => {
      ...
      render(<FileUploadArea {...defaultProps} isProcessing={true} data-testid="processing-click" />);
  ...
  describe('Accessibility', () => {
    it('has proper role and tabIndex for keyboard navigation', () => {
      render(<FileUploadArea {...defaultProps} data-testid="accessibility-test" />);
    ...
    it('has aria-disabled when processing', () => {
      render(<FileUploadArea {...defaultProps} isProcessing={true} data-testid="aria-disabled" />);
    ...
    it('has tabIndex -1 when processing', () => {
      render(<FileUploadArea {...defaultProps} isProcessing={true} data-testid="tabindex-processing" />);
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('does not open file dialog on keyboard when processing', async () => {
      ...
      render(<FileUploadArea {...defaultProps} isProcessing={true} data-testid="keyboard-processing" />);
  ...
  describe('Customization', () => {
    it('applies custom className', () => {
      render(<FileUploadArea {...defaultProps} className="custom-class" data-testid="custom-class" />);
    ...
    it('uses custom maxFileSize and maxPages in requirements', () => {
      ...
      expect(screen.getByText(/Maximum file size: 10MB, Maximum pages: 20/)).toBeInTheDocument();
  ...
  describe('Ref Forwarding', () => {
    it('forwards ref to the root element', () => {
      ...
      render(<FileUploadArea {...defaultProps} ref={ref} data-testid="ref-test" />);
  ...
  describe('File Input Properties', () => {
    it('disables file input when processing', () => {
      render(<FileUploadArea {...defaultProps} isProcessing={true} data-testid="disabled-input" />);
    ...
    it('enables file input when not processing', () => {
      render(<FileUploadArea {...defaultProps} isProcessing={false} data-testid="enabled-input" />);
    ...
    it('has correct accept attribute', () => {
      render(<FileUploadArea {...defaultProps} accept=".pdf,.doc" data-testid="accept-attr" />);
  ...
  describe('Visual Feedback', () => {
    ...
    it('applies correct icon colors for different states', () => {
      const { rerender } = render(<FileUploadArea {...defaultProps} data-testid="icon-colors" />);
