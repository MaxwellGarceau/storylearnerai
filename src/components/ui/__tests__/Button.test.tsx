...
describe('Button Component', () => {
  ...
  it('renders with default variant', () => {
    ...
    const button = within(container).getByRole('button', { name: 'Default Button' });
  ...
  it('renders with destructive variant', () => {
    ...
    const button = within(container).getByRole('button', { name: 'Destructive Button' });
  ...
  it('renders with ghost variant', () => {
    ...
    const button = within(container).getByRole('button', { name: 'Ghost Button' });
  ...
  it('renders with link variant', () => {
    ...
    const button = within(container).getByRole('button', { name: 'Link Button' });
  ...
  it('has proper base styling classes', () => {
    ...
    const button = within(container).getByRole('button', { name: 'Styled Button' });
  ...
  it('combines variant and size classes correctly', () => {
    ...
    const button = within(container).getByRole('button', { name: 'Large Secondary' });
    expect(button).toHaveClass('bg-secondary', 'text-secondary-foreground', 'h-11', 'px-8');
  });
  ...
  it('supports custom HTML button attributes', () => {
    ...
    const button = within(container).getByRole('button', { name: 'Submit Form' });
    expect(button).toHaveAttribute('type', 'submit');
