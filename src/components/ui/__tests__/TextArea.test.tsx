...
describe('TextArea Component', () => {
  ...
  it('renders with required props', () => {
    ...
    const textarea = within(container).getByRole('textbox', { name: 'Test Label' });
  ...
  it('displays helper text when provided', () => {
    ...
    const helperText = within(container).getByText('This is helper text for the textarea');
  ...
  it('associates helper text with textarea using aria-describedby', () => {
    ...
    const textarea = within(container).getByRole('textbox');
    expect(textarea).toHaveAttribute('aria-describedby', `${defaultProps.id}-helper`);
  });
  ...
  it('works with complex form scenarios', () => {
    ...
    const textarea = within(container).getByRole('textbox', { name: 'Your Story' });
    const label = within(container).getByText('Your Story');
    const helperText = within(container).getByText('Write a compelling story in any language');
    ...
    expect(textarea).toHaveAttribute('aria-describedby', 'story-textarea-helper');
