...
describe('translationService', () => {
  ...
  describe('translate', () => {
    ...
    it('should handle translation errors', async () => {
      vi.mocked(EnvironmentConfig.isMockTranslationEnabled).mockReturnValue(false)
      vi.mocked(llmServiceManager.generateCompletion).mockRejectedValue(new Error('Translation failed'))
      ...
      await expect(translationService.translate(request)).rejects.toThrow('Translation failed')
    })
  })
