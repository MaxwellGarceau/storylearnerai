...
export default {
  meta: {
    ...
    schema: [
      {
        ...
        properties: {
          ignorePatterns: {
            ...
            items: { type: 'string' },
            description:
              'Regex patterns to ignore (e.g., technical strings, URLs)',
          },
          minLength: {
            type: 'number',
            description:
              'Minimum string length to trigger the rule (default: 3)',
            default: 3,
          },
          allowedProps: {
            type: 'array',
    ...
    messages: {
      nonLocalizedText:
        "Non-localized text '{{text}}' found. Use t('{{key}}') from react-i18next instead.",
    },
  },
        ...
        suggest: [
          {
            ...
            fix: fixer => {
              return fixer.replaceText(
                node,
                `${translationFunctionName}('${suggestedKey}')`
              );
            },
          },
        ],
