...
export default tseslint.config(
  ...
  prettierConfig,
  // Regular TypeScript files (excluding tests)
  {
    files: ['**/*.{ts,tsx}'],
    ...
    rules: {
      ...
      'no-restricted-properties': [
        'error',
        {
          ...
          property: 'log',
          message:
            'Use logger.info() instead of console.log() for structured logging',
        },
        {
          object: 'console',
          property: 'debug',
          message:
            'Use logger.debug() instead of console.debug() for structured logging',
        },
        {
          object: 'console',
          property: 'info',
          message:
            'Use logger.info() instead of console.info() for structured logging',
        },
      ],
      ...
      'custom/no-duplicate-types': [
        'warn',
        {
          ignoreTypes: [
            ...
            'ViMockFunction',
            'AuthErrorOrString',
            'WalkthroughStateCallback',
            'WalkthroughConfigOrNull',
            'TranslationResponsePromise',
            'PromptInstructionsOrNull',
            'RecordUnknownOrUndefined',
            'LlamaMessage',
            'LlamaMessageArray',
            'SaveFieldType',
            'SupabaseEventCallback',
            'SupabaseEventCallbackOrUndefined',
            // Database types
            ...
            'DatabaseNullableNumber',
            'DatabaseOperation',
            'DatabaseOperationOrNull',
            'UserInsertResult',
            'UserSelectResult',
            'UserUpdateResult',
            'TranslationInsertResult',
            'TranslationSelectResult',
  ...
  // ConsoleWrapper configuration - exclude from console restrictions
  {
    files: ['**/ConsoleWrapper.ts'],
    rules: {
      'no-console': 'off',
